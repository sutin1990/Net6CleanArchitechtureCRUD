...
namespace CleanMovie.API.Migrations
{
    ...
    [Migration("20221219042901_addrelationshipnew")]
    partial class addrelationshipnew
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CleanMovie.Domain.DBModels.MoviesRentalTransaction", b =>
                {
                    b.HasOne("CleanMovie.Domain.DBModels.Movie", "Movie")
                        .WithMany("MoviesRentalTransactions")
                        .HasForeignKey("MovieId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CleanMovie.Domain.DBModels.UserLoginDto", "UserLoginDto")
                        .WithMany("MoviesRentalTransactions")
            ...
            modelBuilder.Entity("CleanMovie.Domain.DBModels.Movie", b =>
                {
                    b.Navigation("MoviesRentalTransactions");
                });
